...
const navigation = [
  ...
  },
  {
    ...
    children: [
      ...
      { name: 'Reconciliation V2', href: 'BankReconciliationV2', icon: FileCheck },
...
export default function Layout({ children, currentPageName }) {
  ...
  const mainPages = ['Dashboard', 'Borrowers', 'Loans', 'Investors', 'InvestorProducts', 'Ledger', 'Receipts', 'BankReconciliation', 'BankReconciliationV2', 'OrphanedEntries', 'Expenses', 'OtherIncome', 'Products', 'Config', 'Users', 'ImportLoandisc', 'ImportExpenses', 'ImportHistoricalDisbursements', 'ImportInvestors', 'ImportInvestorTransactions', 'AuditLog', 'SuperAdmin', 'OrgAdmin', 'About'];
