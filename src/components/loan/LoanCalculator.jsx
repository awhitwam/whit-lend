...
/**
 * Calculate settlement amount with detailed breakdown
 * This is the single source of truth for settlement calculations used by both
 * SettleLoanModal and LetterGeneratorModal
 *
 * @param {Object} loan - Loan object
 * @param {string|Date} settlementDate - Settlement date
 * @param {Array} transactions - Array of transactions
 * @param {Array} schedule - Repayment schedule
 * @param {Object} product - Loan product
 * @returns {Object|null} Settlement calculation result or null if dates invalid
 */
export function calculateSettlementAmount(loan, settlementDate, transactions = [], schedule = [], product = null) {
  const startDate = new Date(loan.start_date);
...
/**
 * Build complete settlement data object for PDF generation
 * This is the single function to call when generating settlement statements
 *
 * @param {Object} loan - Loan object
 * @param {string|Date} settlementDate - Settlement date
 * @param {Array} transactions - Array of transactions
 ...
 * @returns {Object|null} Complete settlement data for PDF generation or null if invalid
 */
export function buildSettlementData(loan, settlementDate, transactions, schedule, product, organization, borrower) {
